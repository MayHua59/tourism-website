...
import styles from './HotelCategoryList.module.css'; 

const HotelCategoryListPage = ({ categories }) => {
  if (!categories || categories.length === 0) {
    return (
      <div className={styles.pageContainer} style={{ textAlign: 'center' }}>
        <h1 className={styles.pageTitle}>Hotel Categories</h1>
        <p className={styles.noItemsText}>No hotel categories found at the moment. Please check back later!</p>
      </div>
    );
  }
  ...
  return (
    <div className={styles.pageContainer}>
      <h1 className={styles.pageTitle}>Explore Hotel Categories</h1>
...
export default HotelCategoryListPage;
