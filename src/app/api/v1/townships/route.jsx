...
const EXTERNAL_API_BASE_URL = process.env.EXTERNAL_VILLAGES_API_BASE_URL || 'https://hotel.software100.com.mm/api/v1/townships';
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { message: `Failed to fetch villages. Status: ${response.status}` },
