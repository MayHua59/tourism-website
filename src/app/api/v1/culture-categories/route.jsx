...
// const EXTERNAL_API_BASE_URL = process.env.EXTERNAL_CULTURE_CATEGORIES_API_BASE_URL || 'https://hotel.software100.com.mm/api/v1/culture-categories';
...
//         { message: `Failed to fetch culture categories. Status: ${response.status}` },
//         { status: response.status }
//       );
//     }

//     const cultureCategories = await response.json();
//     return NextResponse.json(cultureCategories);
