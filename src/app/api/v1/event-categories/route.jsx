...
// const EXTERNAL_API_BASE_URL = process.env.EXTERNAL_EVENT_CATEGORIES_API_BASE_URL || 'https://hotel.software100.com.mm/api/v1/event-categories';
...
//         { message: `Failed to fetch event categories. Status: ${response.status}` },
...
export async function GET(request) {
  try {
    ...
    const eventCategoriesData = await response.json();
    return NextResponse.json(eventCategoriesData);
