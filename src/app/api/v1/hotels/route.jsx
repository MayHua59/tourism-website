...
// const EXTERNAL_API_BASE_URL = process.env.EXTERNAL_HOTELS_API_BASE_URL || 'https://hotel.software100.com.mm/api/v1/hotels';
...
//         { message: `Failed to fetch hotels. Status: ${response.status}` },
